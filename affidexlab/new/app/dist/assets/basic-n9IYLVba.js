import{A as mi,i as N,b as O,c,ac as yn,g as xn,w as Ne}from"./solana-wallet-BJ6Vl-vM.js";import{e as Cn,f as $n,n as u,c as T,o as W,r as I,U as he,a as Rn}from"./index-KJWk5bN5.js";import{e as G,r as q,f as M,i as z,O as ee,k,E as te,R as U,m as Me,a as K,n as j,o as ft,l as In,W as pt,C as Xt,b as vi,T as Zt,h as Xe,M as tn,p as nn,c as En}from"./core-CGmbNXQ7.js";import"./index.es-BawQe-AV.js";var Et,yi;function Wn(){return yi||(yi=1,Et=function(e){for(var i=[],n=e.length,o=0;o<n;o++){var t=e.charCodeAt(o);if(t>=55296&&t<=56319&&n>o+1){var a=e.charCodeAt(o+1);a>=56320&&a<=57343&&(t=(t-55296)*1024+a-56320+65536,o+=1)}if(t<128){i.push(t);continue}if(t<2048){i.push(t>>6|192),i.push(t&63|128);continue}if(t<55296||t>=57344&&t<65536){i.push(t>>12|224),i.push(t>>6&63|128),i.push(t&63|128);continue}if(t>=65536&&t<=1114111){i.push(t>>18|240),i.push(t>>12&63|128),i.push(t>>6&63|128),i.push(t&63|128);continue}i.push(239,191,189)}return new Uint8Array(i).buffer}),Et}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ri=()=>new _n;class _n{}const Wt=new WeakMap,ai=Cn(class extends $n{render(r){return mi}update(r,[e]){var n;const i=e!==this.G;return i&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=e,this.ht=(n=r.options)==null?void 0:n.host,this.rt(this.ct=r.element)),mi}rt(r){if(this.G!==void 0)if(this.isConnected||(r=void 0),typeof this.G=="function"){const e=this.ht??globalThis;let i=Wt.get(e);i===void 0&&(i=new WeakMap,Wt.set(e,i)),i.get(this.G)!==void 0&&this.G.call(this.ht,void 0),i.set(this.G,r),r!==void 0&&this.G.call(this.ht,r)}else this.G.value=r}get lt(){var r,e;return typeof this.G=="function"?(r=Wt.get(this.ht??globalThis))==null?void 0:r.get(this.G):(e=this.G)==null?void 0:e.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),Sn=N`
  :host {
    position: relative;
