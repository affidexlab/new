import{s as ve,a as fe,p as ge,i as v,b as f,c as a}from"./solana-wallet-BJ6Vl-vM.js";import{c as u,n as w,r as d,o as q,U as be}from"./index-KJWk5bN5.js";import{w as ye,M as g,S as se,R as l,r as P,A as K,e as ce,c as le,C as m,a as Y,b as xe,d as S,E as ie,O as E,f as F,g as oe,h as T,i as H,T as Ce,j as ke,k as Se,l as We}from"./core-CGmbNXQ7.js";import"./index.es-BawQe-AV.js";const p=ge({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return fe(p,()=>r(p))},subscribeKey(r,e){return ve(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ye(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
