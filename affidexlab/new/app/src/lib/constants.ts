...
export const BASE_TOKENS: Token[] = [
  ...
  },
  {
    ...
    decimals: 18,
    logo: "https://tokens.1inch.io/0x4200000000000000000000000000000000000006.png",
    chainId: CHAIN_IDS.BASE,
  },
  {
    symbol: "USDC",
...
export const OPTIMISM_TOKENS: Token[] = [
  ...
  },
  {
    ...
    decimals: 18,
    logo: "https://ethereum-optimism.github.io/data/OP/logo.png",
    chainId: CHAIN_IDS.OPTIMISM,
  },
  {
    symbol: "DAI",
...
export const API_ENDPOINTS: Record<number, { zeroX?: string; cow?: string }> = {
  [CHAIN_IDS.ARBITRUM]: {
    ...
    cow: "https://api.cow.fi/mainnet/api/v1",
  },
  [CHAIN_IDS.AVALANCHE]: {
