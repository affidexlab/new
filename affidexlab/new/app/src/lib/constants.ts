...
export const AVALANCHE_TOKENS = [
  {
    ...
    decimals: 18,
    logo: "https://tokens.1inch.io/0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_1.png"
  },
  {
    symbol: "WAVAX",
    name: "Wrapped AVAX",
...
// BNB Smart Chain Token Addresses
...
export const TREASURY_WALLET = "0x65b7a307a7e67e38840b91f9a36bf8dfe6e02901";
export const SWAP_FEE_BPS = 80;
export const BRIDGE_FEE_BPS = 80;
export const POOL_FEE_BPS = 50;
