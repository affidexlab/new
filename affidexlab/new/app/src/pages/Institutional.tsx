...
const FAQS = [
  { q: "Is DecaFlow Institutional live?", a: "Yes. DecaFlow Institutional is live as a complete compliance infrastructure suite for RWA issuers. It includes DecaFlow-native KYC/KYB/accreditation (no third-party dependency), on-chain identity attestations, automated investor eligibility checks, and pre-audited ERC-3643 contract templates. Your securities counsel must still review your specific offering and jurisdiction requirements before any real issuance." },
  ...
  { q: "Does DecaFlow handle KYC and accreditation?", a: "Yes. DecaFlow is your KYC/KYB/accreditation provider — not a third-party integration. You submit documents through our portal, DecaFlow analysts review and verify, and approved wallets receive on-chain identity attestations. Accredited investor verification supports all standard bases: income, net worth, licensed professional, qualified entity, and knowledgeable employee." },
  { q: "What happens after I sign up?", a: "Our team reaches out to scope your specific asset, jurisdiction, and compliance requirements. This is a guided integration process — we help you configure identity rules, compliance checks, and contract deployment for your specific offering." },
