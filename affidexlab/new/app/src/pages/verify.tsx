...
const PLANS = [
  {
    ...
    features: [
      '1,000 wallet checks per month',
      'OFAC & UN sanctions screening',
      'Ethereum & Arbitrum coverage',
      'Basic risk score & flags',
      'Community support',
      'Standard API',
    ],
  ...
  format: 'pdf', // 'pdf' | 'json' | 'csv'
        ...
        <section style={{ padding: '6rem 2rem', textAlign: 'center' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.55)', fontSize: '1rem', maxWidth: '500px', margin: '0 auto 2.5rem', lineHeight: 1.7 }}>
            First 1,000 checks are free. No credit card required. Production-ready in minutes.
          </p>
          <a
